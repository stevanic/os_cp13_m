CLASS zcl_generate_demo_data_9955 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_GENERATE_DEMO_DATA_9955 IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    DELETE FROM zrap_abook_9955.

    " insert travel demo data
    INSERT zrap_atrav_9955 FROM (
        SELECT
          FROM /dmo/travel
          FIELDS
            uuid(  )      AS travel_uuid           ,
    ...
    INSERT zrap_abook_9955 FROM (
        SELECT
          FROM   /dmo/booking    AS booking
            JOIN zrap_atrav_9955 AS z
